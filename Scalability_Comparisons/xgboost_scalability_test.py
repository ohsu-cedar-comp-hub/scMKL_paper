...
parser.add_argument('-s', '--feature_subset', help = 'Which_features to subset the data frame', choices = ['all', 'hallmark', 'mvf', 'dimension_reduction'], default= None)
...
output_dir = f'/home/groups/CEDAR/scMKL/results/scalability_tests/{assay}/XGBoost/{subset}/{n_cells}'
